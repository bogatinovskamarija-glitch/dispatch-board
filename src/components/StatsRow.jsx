export default function StatsRow({ loads, statusFilter, onFilterChange }) {
  ...
  const counts = { covered: 0, empty: 0, home: 0, broken: 0, no_driver: 0, prebooked: 0, at_pickup: 0, at_delivery: 0 }
  ...
  const CARDS = [
    ...
    { status: 'at_pickup',   dot: 'dot-sky',    label: 'At Pick Up',  count: counts.at_pickup   },
    { status: 'at_delivery', dot: 'dot-orange', label: 'At Delivery', count: counts.at_delivery },
  ]
